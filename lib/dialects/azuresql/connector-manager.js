...
module.exports = (function() {
  ...
  var connect = function(done, config) {
	...
	console.log(config)
	console.log("AzureSQL connection string: " + config.dialectOptions.connectionString);

	
	var connection = azuresql.open(config.dialectOptions.connectionString,function(err,conn){
		if (err) {
